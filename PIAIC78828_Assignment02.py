...
def function5():
    ...
    z =np.full((4,5),0)  #wrtie your code here
...
def function8():
    ...
    x =np.full((2,5),6, dtype="int32")  #write your code here
...
def function12():
    ...
    ans =np.concatenate((arr1,arr2),axis=0)  #write your code here 
...
def function13():
    ...
    ans =np.extract((5<arr) & (arr<10), arr)  #write your code here 
...
def function19():
    ...
    W =np.array(X).swapaxes(1,0)    # Write your code here 
